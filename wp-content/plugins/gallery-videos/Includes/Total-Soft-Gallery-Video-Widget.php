		...
		function widget($args,$instance)
		{
			...
			if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Grid Video Gallery'){ ?>
				<style type="text/css">
					...
					.grid-gallery<?php echo $Total_Soft_Gallery_Video; ?> figure img { display: block; width: 100%; margin: 0; }
					...
					.grid<?php echo $Total_Soft_Gallery_Video; ?> { margin: 0 auto; }
					.grid<?php echo $Total_Soft_Gallery_Video; ?> li { float: left; cursor: pointer; left:0px; list-style-type: none !important; padding:0px !important; margin:0px !important; }
				...
				<script type="text/javascript">
					;( function( window ) {
						...
						CBPGridGallery<?php echo $Total_Soft_Gallery_Video; ?>.prototype._openSlideshow<?php echo $Total_Soft_Gallery_Video; ?> = function( pos ) {
							...
							{
								jQuery(this.currentItem<?php echo $Total_Soft_Gallery_Video; ?>).find('iframe').attr('src', jQuery(this.currentItem<?php echo $Total_Soft_Gallery_Video; ?>).find('iframe').attr('src').split('?autoplay=0')[0]+'?autoplay=1');
							}
					...
					{
						jQuery(window).scrollTop(jQuery('#GRU'+TotalSoftGV_ID).position().top);
			...
			<?php } else if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='LightBox Video Gallery'){ ?>
				...
				<style type="text/css">
					...
					* html .clearfix<?php echo $Total_Soft_Gallery_Video; ?> { height:1%; }
					...
					.totalsoft-gv-lvg-area<?php echo $Total_Soft_Gallery_Video; ?> { text-align:center; }
					...
					.fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .lImgZoom4_<?php echo $Total_Soft_Gallery_Video; ?> { width:150%; left:-25%; top:-25%; }
					...
					.hovLink, .hovLink:hover { text-decoration:none !important; box-shadow: none !important; -moz-box-shadow: none !important; -webkit--box-shadow: none !important; }
									...
									<li class="totalsoft-gv-lvg-item2 TotalSoft_GV_LVG_Li" id="TotalSoft_GV_LVG_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" style='max-width:100%;'>
										<div class='fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>'>
											<span class="totalsoft-gv-lvg-image-block<?php echo $Total_Soft_Gallery_Video; ?>"> 
												<a class="image-zoom" href="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_Video;?>" rel="prettyPhoto[gallery_<?php echo $Total_Soft_Gallery_Video; ?>]" title="<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14=='true'){ echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;} ?>">
													<img class='LImg <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_10;?>_<?php echo $Total_Soft_Gallery_Video; ?>' src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" alt="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>" title="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>"/>
				...
				jQuery(document).ready(function(){
					...
					function imH(){
						...
						jQuery('.fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>').css('height',jQuery('.LImg').height());
					}
				...
				<div class="main TotalSoft_GV_CP_Main TotalSoft_GV_CP_Main<?php echo $Total_Soft_Gallery_Video;?>">
					<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i++){ ?>
						...
						<?php } else { ?>
							...
							<?php } else { ?>
								<div class="totalsoftview totalsoftview<?php echo $Total_Soft_Gallery_Video;?> totalsoftview-<?php echo $TotSoft[$TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09];?>" id="TotalSoft_GV_CP_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" style="display:none;" onclick="TotalSoft_GV_CP_Cont<?php echo $Total_Soft_Gallery_Video;?>('<?php echo $Total_Soft_GalleryV_Videos[$i]->id;?>', '<?php echo $Total_Soft_Gallery_Video;?>')">
									<img src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>"/>
									<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09=='2'){ ?>
										<div class="mask"></div>
										<div class="content content<?php echo $Total_Soft_Gallery_Video;?>">
				...
				<script type="text/javascript">
					function TotalSoft_GV_CP_Cont<?php echo $Total_Soft_Gallery_Video;?>(TotalSoftGV_CP_VID, TotalSoftGV_CP_ID)
					{
						...
						jQuery.post(ajaxurl, data, function(response) {
							...
							jQuery('.TotalSoft_GV_CP_Iframe<?php echo $Total_Soft_Gallery_Video;?> iframe').attr('src',b[4]);
					...
					function TotalSoft_GV_CP_Left<?php echo $Total_Soft_Gallery_Video;?>(TotalSoftGV_CP_ID)
					{
						...
						jQuery.post(ajaxurl, data, function(response) {
							...
							jQuery('.TotalSoft_GV_CP_Iframe<?php echo $Total_Soft_Gallery_Video;?> iframe').attr('src',b[5]);
				...
				<script>
					jQuery(document).ready(function(){
						...
						function resp<?php echo $Total_Soft_Gallery_Video;?>()
						{
							...
							{
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').css('width',Math.floor(CPWIDTHVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/300));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').css('height',Math.floor(CPHeightVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/300));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?> .mask').css('width',Math.floor(CPWIDTHVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/300));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?> .mask').css('height',Math.floor(CPHeightVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/300));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?> .content<?php echo $Total_Soft_Gallery_Video;?>').css('width',Math.floor(CPWIDTHVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/300));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?> .content<?php echo $Total_Soft_Gallery_Video;?>').css('height',Math.floor(CPHeightVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/300));
							...
							{
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').css('width',Math.floor(CPWIDTHVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/700));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').css('height',Math.floor(CPHeightVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/700));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?> .mask').css('width',Math.floor(CPWIDTHVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/700));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?> .mask').css('height',Math.floor(CPHeightVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/700));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?> .content<?php echo $Total_Soft_Gallery_Video;?>').css('width',Math.floor(CPWIDTHVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/700));
								jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?> .content<?php echo $Total_Soft_Gallery_Video;?>').css('height',Math.floor(CPHeightVideo<?php echo $Total_Soft_Gallery_Video;?>*jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width()/700));
			...
			<?php } else if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Elastic Gallery') { ?>
				...
				<div id="video-gallery" class='Tot_Vid_Gallery<?php echo $Total_Soft_Gallery_Video;?>' style='text-align:center;'>
					<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i++){ ?>
						...
						<?php }else{ ?>
							...
							<?php }else{ ?>
								<div style='display:none;' id="TotalSoft_GV_HLG_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" class='fhovZoom<?php echo $Total_Soft_Gallery_Video;?>' href="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_Video;?>" data-poster="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" onclick='TotalsofthPIcon()'>
									<a href='#'>
										<img class='zEff <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08;?>' style='max-width:none;' src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" />
										<div class='<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14;?>' style='background:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_13;?>;'> 
											<span style='margin-left:5px; font-size: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?>px; color:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_11;?>; font-family: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_12;?>; display:<?php echo $TotalSoft_GV_1_16;?>'>
				...
				<script type="text/javascript">
					...
					resp<?php echo $Total_Soft_Gallery_Video;?>();
					jQuery(window).resize(function(){ resp<?php echo $Total_Soft_Gallery_Video;?>(); })
					jQuery(document).ready(function(){ jQuery('.Tot_Vid_Gallery<?php echo $Total_Soft_Gallery_Video;?>').lightGallery<?php echo $Total_Soft_Gallery_Video;?>()});
			...
			<?php } else if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Parallax Engine'){ ?>
				...
				<style>
					...
					@media screen and (max-width:700px){ ul.pagination<?php echo $Total_Soft_Gallery_Video;?> li span { cursor:default; } }
				</style>
				<div class="TotSoft_GV_Container TotSoft_GV_Container_<?php echo $Total_Soft_Gallery_Video;?> myExMul" id="swipeboxVideo_Totsoft">
					<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i++){ ?>
						<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType=='All'){ ?>
							...
							<?php }else{ ?>
								<a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>"  class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video;?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL;?>" name="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>">
									<img class="TotalSoft_HZ2" alt="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" />
									<span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
										<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>
										<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15==1 || $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15=='true') { ?>
						...
						<?php }else{ ?>
							...
							<?php }else{ ?>
								<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_29==1) { ?>
									<a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" style="display:none;"  class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video;?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_Video;?>" name="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>">
										<img class="TotalSoft_HZ2" alt="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" />
										<span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
											<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>
											<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15==1 || $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15=='true') { ?>
								...
								<?php }else{ ?>
									<a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" style="display:none;"  class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video;?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL;?>" name="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>">
										<img class="TotalSoft_HZ2" alt="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" />
										<span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
											<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>
											<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15==1 || $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15=='true') { ?>
					...
					function TotalSoft_Hov_Anim(event){
						...
						jQuery('.TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>').each(function(){
							...
							jQuery(this).mousemove(function(event){
								...
								if(title=="TotalSoft_Title_Ef1")
								{
									jQuery(this).find(".TotalSoft_Title_Ef1").css({"transform":"translateY("+Math.floor(((event.pageY-jQuery(this).find(".TotalSoft_Title_Ef1").offset().top)/5-jQuery(this).find(".TotalSoft_Title_Ef1").height()/2))+"px) translateX("+Math.floor(((event.pageX-jQuery(this).find(".TotalSoft_Title_Ef1").offset().left)/5-jQuery(this).find(".TotalSoft_Title_Ef1").width()/2))+"px)","-webkit-transform":"translateY("+Math.floor(((event.pageY-jQuery(this).find(".TotalSoft_Title_Ef1").offset().top)/5-jQuery(this).find(".TotalSoft_Title_Ef1").height()/2))+"px) translateX("+Math.floor(((event.pageX-jQuery(this).find(".TotalSoft_Title_Ef1").offset().left)/5-jQuery(this).find(".TotalSoft_Title_Ef1").width()/2))+"px)","-ms-transform":"translateY("+Math.floor(((event.pageY-jQuery(this).find(".TotalSoft_Title_Ef1").offset().top)/5-jQuery(this).find(".TotalSoft_Title_Ef1").height()/2))+"px) translateX("+Math.floor(((event.pageX-jQuery(this).find(".TotalSoft_Title_Ef1").offset().left)/5-jQuery(this).find(".TotalSoft_Title_Ef1").width()/2))+"px)","-moz-transform":"translateY("+Math.floor(((event.pageY-jQuery(this).find(".TotalSoft_Title_Ef1").offset().top)/5-jQuery(this).find(".TotalSoft_Title_Ef1").height()/2))+"px) translateX("+Math.floor(((event.pageX-jQuery(this).find(".TotalSoft_Title_Ef1").offset().left)/5-jQuery(this).find(".TotalSoft_Title_Ef1").width()/2))+"px)","-o-transform":"translateY("+Math.floor(((event.pageY-jQuery(this).find(".TotalSoft_Title_Ef1").offset().top)/5-jQuery(this).find(".TotalSoft_Title_Ef1").height()/2))+"px) translateX("+Math.floor(((event.pageX-jQuery(this).find(".TotalSoft_Title_Ef1").offset().left)/5-jQuery(this).find(".TotalSoft_Title_Ef1").width()/2))+"px)"})
								}
								else if(title=="TotalSoft_Title_Ef4")
								{
									jQuery(this).find(".TotalSoft_Title_Ef4").css({"transform":"rotateX("+Math.floor((event.pageX-jQuery(this).find(".TotalSoft_Title_Ef4").offset().left-jQuery(this).find(".TotalSoft_Title_Ef4").width()/2)/10)+"deg) rotateY("+Math.floor((event.pageY-jQuery(this).find(".TotalSoft_Title_Ef4").offset().top+jQuery(this).find(".TotalSoft_Title_Ef4").height()/2)/10)+"deg) translateY(-50%) translateX(-50%)","-webkit-transform":"rotateX("+Math.floor((event.pageX-jQuery(this).find(".TotalSoft_Title_Ef4").offset().left-jQuery(this).find(".TotalSoft_Title_Ef4").width()/2)/10)+"deg) rotateY("+Math.floor((event.pageY-jQuery(this).offset().top+jQuery(this).height()/2)/10)+"deg) translateY(-50%) translateX(-50%)","-ms-transform":"rotateX("+Math.floor((event.pageX-jQuery(this).offset().left-jQuery(this).width()/2)/10)+"deg) rotateY("+Math.floor((event.pageY-jQuery(this).offset().top+jQuery(this).height()/2)/10)+"deg) translateY(-50%) translateX(-50%)","-moz-transform":"rotateX("+Math.floor((event.pageX-jQuery(this).offset().left-jQuery(this).width()/2)/10)+"deg) rotateY("+Math.floor((event.pageY-jQuery(this).offset().top+jQuery(this).height()/2)/10)+"deg) translateY(-50%) translateX(-50%)","-o-transform":"rotateX("+Math.floor((event.pageX-jQuery(this).offset().left-jQuery(this).width()/2)/10)+"deg) rotateY("+Math.floor((event.pageY-jQuery(this).offset().top+jQuery(this).height()/2)/10)+"deg) translateY(-50%) translateX(-50%)"})
								}
			...
			<?php } else if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Classic Gallery'){ ?>
				<style type="text/css">
					...
					.TS_GV_ClG_<?php echo $Total_Soft_Gallery_Video;?> { position: relative; width: 100%; text-align: center; }
				...
				<div class="TS_GV_ClG_<?php echo $Total_Soft_Gallery_Video;?>">
					<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i++){ ?>
						...
						<?php }else{ ?>
							...
							<?php }else{ ?>
								<div class="TS_GV_ClG_Div1_Main_<?php echo $Total_Soft_Gallery_Video;?>" onclick="TS_GV_ClG_Div_Full<?php echo $Total_Soft_Gallery_Video;?>(<?php echo $Total_Soft_Gallery_Video;?>, <?php echo $i;?>)" id="TS_GV_ClG_Div1_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" style="padding: 0; height: 0; display: none;">
									<div class="TS_GV_ClG_Div1_<?php echo $Total_Soft_Gallery_Video;?>">
										<div class="TS_GV_ClG_Div2_<?php echo $Total_Soft_Gallery_Video;?>">
											<img id="TS_GV_ClG_Div2_Img_<?php echo $Total_Soft_Gallery_Video . '_' . $i;?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" alt="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL;?>"/>
											<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_02 == 'effect01'){ ?>
			...
			<?php } else if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Space Gallery'){ ?>
				<style type="text/css">
					...
					.TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?>.is-visible 
					{
						-webkit-animation: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01;?> 3s cubic-bezier(0.77, 0.35, 0, 1.6) forwards;
						-moz-animation: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01;?> 3s cubic-bezier(0.77, 0.35, 0, 1.6) forwards;
						animation: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01;?> 3s cubic-bezier(0.77, 0.35, 0, 1.6) forwards;
					}
					...
					.TS_GV_SG_Div_video_<?php echo $Total_Soft_Gallery_Video;?> iframe { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }
				...
				<script type="text/javascript">
					function TotalSoft_GV_SG_OPop<?php echo $Total_Soft_Gallery_Video;?>(SG_ID, SG_V_NUM)
					{
						...
						setTimeout(function(){
							...
							jQuery('.TS_GV_SG_Div_box_'+SG_ID).css({'display':'flex','display':'-webkit-flex'});
					...
					window.addEventListener("load",function(){
						jQuery('.TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?>').each(function(i){
							setTimeout(function(){ jQuery('.TotalSoft_GV_SG_Item_Vis_<?php echo $Total_Soft_Gallery_Video;?>_'+i).addClass('is-visible'); }, 400 * i);
						});
					})
					function Total_Soft_GV_SG_Page(TotalSoftGV_ID, TotalSoftPage, TotalSoftPP, TotalSoftCV)
					{
						jQuery(window).scrollTop(jQuery('.TotalSoft_GV_SG_Website_'+TotalSoftGV_ID).position().top);
						for(i=1;i<=TotalSoftCV;i++)
						{
							if(i>TotalSoftPP*(TotalSoftPage-1) && i<=TotalSoftPP*TotalSoftPage)
							{
								jQuery('.TotalSoft_GV_SG_Item_'+TotalSoftGV_ID+'_'+i).css({'display': 'block'});
								jQuery('.TotalSoft_GV_SG_Item_'+TotalSoftGV_ID+'_'+i).addClass('is-visible');
							}
							else
							{
								jQuery('.TotalSoft_GV_SG_Item_'+TotalSoftGV_ID+'_'+i).css({'display': 'none'});
								jQuery('.TotalSoft_GV_SG_Item_'+TotalSoftGV_ID+'_'+i).removeClass('is-visible');
							}
						}
					...
					function Total_Soft_GV_SG_PageLM(TotalSoftGV_ID, TotalSoftPP, TotalSoftCV, TotalSoftPC)
					{
						...
						if(TotalSoftPage<=TotalSoftPC)
						{
							...
							if(TotalSoftPage==TotalSoftPC)
							{
								jQuery('#TotalSoft_VG_SG_PageDiv_'+TotalSoftGV_ID).css('display','none');
							}
						}
						else
						{
				...
				<div class="TotalSoft_GV_SG_Website_<?php echo $Total_Soft_Gallery_Video;?>">
					<div class="TotalSoft_GV_SG_Grid_<?php echo $Total_Soft_Gallery_Video;?>">
						<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i++){ ?>
							<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType == 'All'){ ?>
								<div class="TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?> TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i;?> TotalSoft_GV_SG_Item_Vis_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i;?>">
									...
									<div class="TotalSoft_GV_SG_Videodiv_<?php echo $Total_Soft_Gallery_Video;?>">
										...
										<?php } else { ?>
											<iframe src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL;?>?autoplay=0&controls=1&showinfo=0&autohide=1" frameborder="0" webkitAllowFullScreen></iframe>
										<?php }?>
									</div>
							...
							<?php } else { ?>
								<?php if($i<$Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_PerPage){ ?>
									<div class="TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?> TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?> TotalSoft_GV_SG_Item_Vis_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i;?>">
										<span class="TotalSoft_GV_SG_VideoTitle_<?php echo $Total_Soft_Gallery_Video;?>">
											<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>
										</span>
										<div class="TotalSoft_GV_SG_Videodiv_<?php echo $Total_Soft_Gallery_Video;?>">
								...
								<?php }else{ ?>
									<div class="TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?> TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" style="display: none;">
										<span class="TotalSoft_GV_SG_VideoTitle_<?php echo $Total_Soft_Gallery_Video;?>">
											<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT;?>
										</span>
										<div class="TotalSoft_GV_SG_Videodiv_<?php echo $Total_Soft_Gallery_Video;?>">
				...
				<?php }?>
				<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType=='Load'){ ?>
					<div class="TotalSoftcenter" style="float: none !important;" id="TotalSoft_VG_SG_PageDiv_<?php echo $Total_Soft_Gallery_Video;?>">
